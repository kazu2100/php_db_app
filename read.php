...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" cntent="width=divice-width, initial-scale=1.0">
  <title>商品一覧</title>
    ...
    <ariticle class="products">
      ...
      <div class="products-ui">
        <div>
          ...
          <form acition="read.php" method="get" class="search-form">
